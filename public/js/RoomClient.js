...
// File transfer settings (now managed by FileTransferManager) 
    ...
    initSockets() {
        ...
        this.socket.on('fileInfo', (data) => this.fileTransferManager.handleFileInfo(data));
        this.socket.on('file', (data) => this.fileTransferManager.handleFile(data));
        this.socket.on('shareVideoAction', this.handleShareVideoAction);
        this.socket.on('fileAbort', (data) => this.fileTransferManager.handleFileAbort(data));
        this.socket.on('receiveFileAbort', (data) => this.fileTransferManager.handleReceiveFileAbort(data));
    ...
    getScreenConstraints() {
        return this.screenShareManager.getScreenConstraints();
    }
    ...
    getScreenEncoding() {
        return this.screenShareManager.getScreenEncoding();
    }
    ...
    async produceScreenAudio(stream) {
        return this.screenShareManager.produceScreenAudio(stream);
    }
    ...
    /**
     * Handles initiating screen sharing by delegating to ScreenShareManager.
     * @returns {void}
     */
    shareScreen() {
        this.screenShareManager.shareScreen();
    }
    ...
    setIsScreen(status) {
        return this.screenShareManager.setIsScreen(status);
    }
    ...
    handleSF(uid, name) {
        return this.fileTransferManager.handleSF(uid, name);
    }

    handleDD(uid, peer_id, itsMe = false) {
        return this.fileTransferManager.handleDD(uid, peer_id, itsMe);
    }

    formatAcceptedFileTypes(accept = '*') {
        return this.fileTransferManager.formatAcceptedFileTypes(accept);
    }

    async openFilePickerModal(options = {}) {
        return this.fileTransferManager.openFilePickerModal(options);
    }

    async selectFileToShare(peer_id, broadcast = false, peer_name = 'all') {
        return this.fileTransferManager.selectFileToShare(peer_id, broadcast, peer_name);
    }

    sendFileInformations(file, peer_id, broadcast = false, peer_name = 'all') {
        return this.fileTransferManager.sendFileInformations(file, peer_id, broadcast, peer_name);
    }

    handleFileInfo(data) {
        return this.fileTransferManager.handleFileInfo(data);
    }

    sendFileData(peer_id, broadcast) {
        return this.fileTransferManager.sendFileData(peer_id, broadcast);
    }

    sendFSData(data) {
        return this.fileTransferManager.sendFSData(data);
    }

    abortFileTransfer() {
        return this.fileTransferManager.abortFileTransfer();
    }

    abortReceiveFileTransfer() {
        return this.fileTransferManager.abortReceiveFileTransfer();
    }

    hideFileTransfer() {
        return this.fileTransferManager.hideFileTransfer();
    }

    isFileReaderRunning() {
        return this.fileTransferManager.isFileReaderRunning();
    }

    handleReceiveFileAbort(data) {
        return this.fileTransferManager.handleReceiveFileAbort(data);
    }

    handleFileAbort(data) {
        return this.fileTransferManager.handleFileAbort(data);
    }

    handleFile(data) {
        return this.fileTransferManager.handleFile(data);
    }

    endFileDownload() {
        return this.fileTransferManager.endFileDownload();
    }

    saveBlobToFile(blob, file) {
        return this.fileTransferManager.saveBlobToFile(blob, file);
    }

    bytesToSize(bytes) {
        return this.fileTransferManager.bytesToSize(bytes);
    }
    ...
    isValidFileName(fileName) {
        return this.fileTransferManager.isValidFileName(fileName);
    }
